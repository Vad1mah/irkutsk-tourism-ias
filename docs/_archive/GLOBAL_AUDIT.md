...
**Охват:** 52 Python-файла backend, 31 TS/TSX-файл frontend, 20 конфиг-файлов
...
**Примечание (28.03.2026):** Страницы `Situation.tsx` и `Dashboard.tsx` переименованы — функционал перенесён в `Analytics.tsx`. Ссылки ниже относятся к состоянию кода на момент аудита.
...
| 42 | проект | — | Alembic подключён (env.py), ревизий нет | 2A |
